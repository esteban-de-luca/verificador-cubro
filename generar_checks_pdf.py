...
GROUPS = [
    ...
    },
    {
        ...
        "checks": [
            ...
            ("C-16", "Acabados pertenecen a la lista validada de su gama",
             "El acabado de cada pieza está en la lista de su gama (WARN bloqueante si no)", "Sí"),
    ...
    },
    {
        ...
        "checks": [
            ...
            ("C-27", "Rodapiés: R solo vacío/'cor.'; RV solo 'vent.'",
             "R con vacío o 'cor.'; RV solo con 'vent.' (WARN bloqueante si no)", "Sí"),
